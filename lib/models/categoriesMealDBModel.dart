...
class CategoriesMealDBModel {
  CategoriesMealDBModel({List<Categories>? categories}) {
    _categories = categories;
  }

  CategoriesMealDBModel.fromJson(dynamic json) {
  ...
  CategoriesMealDBModel copyWith({List<Categories>? categories}) =>
      CategoriesMealDBModel(categories: categories ?? _categories);
