...
class CategoriesMealModel {
  CategoriesMealModel({List<Categories>? categories}) {
    _categories = categories;
  }

  CategoriesMealModel.fromJson(dynamic json) {
  ...
  CategoriesMealModel copyWith({List<Categories>? categories}) =>
      CategoriesMealModel(categories: categories ?? _categories);
